...
class UserAgent:
    ...
    def get_user_analysis(
        self, role: str, pdf_path: str, reco_txt_paths: list, ideal_skills_list
    ):
        ...
        skills_trust_score = self.skills_agent.get_skills_trust_score(
            role, skills, experience
        )
        skills_relevance_score = self.skills_agent.get_skills_relevance_score(
            role, skills, ideal_skills_list, experience
        )
        ...
        return {
            "skills_relevance_score": skills_relevance_score,
